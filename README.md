...
- **Documents**
  - **Architecture** [`docs/ICARUS-LEO-Architecture.pdf`](docs/ICARUS-LEO-Architecture.pdf) — what the simulator does and its architecture.
  - **User guide** [`docs/ICARUS-LEO-UserGuide.md`](docs/ICARUS-LEO-UserGuide.md) — how to use the simulator.
